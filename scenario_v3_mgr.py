...
Identisch zu Szenario v3 - bis auf EINE vorangestellte Zeile:
    ...
    Du bist Manager des Bereichs, der billing-api verantwortet.
...
ROLE = "Du bist Manager des Bereichs, der billing-api verantwortet."

SCENARIO_ID = _base.SCENARIO_ID + "-rolle-manager"
