"""
Rollen-Arm mit Entscheidungsanteil (mgr).

Aufbauend auf scenario_v3_mgr_corp (Rolle + Konzern-Kontext + Werkzeugkasten)
...
"""
from scenario_v3_mgr_corp import *      # noqa: F401,F403
import scenario_v3_mgr_corp as _base
